  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Find Perfect Projects</h1>
          <p className="text-gray-600">Browse through available projects or use filters to find the perfect match for your skills</p>
        </div>
            ...
            <div className="flex-1">
              <form onSubmit={handleSearch} className="relative">
                <input
                  ...
                  className="w-full h-12 pl-12 pr-4 rounded-lg border-2 border-gray-200 focus:border-stdBlue focus:ring-2 focus:ring-stdBlue/20 transition-all outline-none"
                />
